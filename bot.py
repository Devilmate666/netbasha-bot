...
CATEGORY_MSGS = {
    ...
    "sports": [
        ...
        lambda: (
            "⚡ *بث مباشر بديل*\n\n"
            "مصدر ثانٍ للمباريات المباشرة — إذا توقف بث، هذا البديل جاهز 🔁",
            site_url("sports", 3),
            "🔁 جرّب البث البديل"
        ),
        lambda: (
    ...
    "social": [
        lambda: (
            "📘 *فيسبوك*\n\n"
            "ابقَ على تواصل مع أصدقائك ومجموعاتك — "
            "إشعاراتك ومنشوراتك في انتظارك 👥",
            site_url("social", 0),
            "👥 افتح فيسبوك"
        ),
        lambda: (
            "🐦 *X — تويتر*\n\n"
            "اكتشف ما يتحدث عنه العالم الآن — "
            "الترندات والنقاشات الساخنة تنتظرك 🔥",
            site_url("social", 1),
            "🔥 تصفّح X الآن"
        ),
        lambda: (
            "📷 *إنستغرام*\n\n"
            "ريلز وستوريز تتجدد كل لحظة — "
            "اكتشف محتوى يلهمك من حول العالم 🎬",
            site_url("social", 2),
            "🎬 تصفّح إنستغرام"
        ),
        lambda: (
            "📹 *يوتيوب*\n\n"
            "أكبر منصة فيديو في العالم — ابحث عن أي موضوع "
            "وستجد آلاف المقاطع التي تنتظر مشاهدتك ▶️",
            site_url("social", 3),
            "▶️ استكشف يوتيوب"
        ),
        lambda: (
            "🎵 *تيك توك*\n\n"
            "الترند الجديد يبدأ هنا — فيديوهات قصيرة لا تنتهي "
            "في كل موضوع يخطر على بالك 🎬",
            site_url("social", 4),
            "🎬 اكتشف تيك توك"
        ),
        lambda: (
            "👻 *سناب شات*\n\n"
            "ستوريز وسنابات تختفي في 24 ساعة — "
            "تواصل لحظي خفيف مع من تحب 📸",
            site_url("social", 5),
            "📸 افتح سناب شات"
        ),
        lambda: (
            "🎮 *ديسكورد*\n\n"
            "سيرفرات المجتمعات والمجموعات — "
            "العب، ناقش، وانضم إلى مجتمع يشاركك نفس الاهتمامات 🔗",
            site_url("social", 6),
            "🔗 انضم إلى ديسكورد"
        ),
        lambda: (
            "🟣 *تويتش*\n\n"
            "بثوث مباشرة لا تتوقف — ألعاب، موسيقى، محادثات ووجوه جديدة "
            "يمكنك متابعتها الآن 🔴",
            site_url("social", 7),
        ...
        lambda: (
            "💼 *لينكد إن*\n\n"
            "شبكتك المهنية في مكان واحد — فرص عمل، مقالات تطويرية، "
            "وتواصل مع أصحاب القرار في مجالك 🌐",
            site_url("social", 8),
            "🌐 افتح لينكد إن"
        ),
        lambda: (
            "💬 *واتساب ويب*\n\n"
            "راسل أصدقاءك ومجموعاتك من متصفحك مباشرةً — "
            "بسرعة وبدون الحاجة لفتح هاتفك 📲",
            site_url("social", 9),
            "📲 افتح واتساب ويب"
        ),
        lambda: (
            "🧵 *ثريدز*\n\n"
            "منصة النقاش الجديدة من Meta — انشر أفكارك وتابع "
            "المحادثات التي تهمك في فضاء أكثر هدوءاً 💭",
            site_url("social", 10),
            "💭 اكتشف ثريدز"
        ),
        lambda: (
            "📌 *بينترست*\n\n"
            "لوحة إلهام لا نهاية لها — ديكور، موضة، وصفات، سفر، فن — "
            "احفظ ما يعجبك وابنِ مكتبتك البصرية 🎨",
            site_url("social", 11),
            "🎨 استكشف بينترست"
        ),
        lambda: (
            "🤖 *ريديت*\n\n"
            "أكبر منتدى نقاش في العالم — آلاف المجتمعات في كل تخصص "
            "تنتظر أسئلتك وآراءك 💬",
            site_url("social", 12),
            "💬 تصفّح ريديت"
        ),
        lambda: (
            "❓ *كورا — قهوة الأسئلة*\n\n"
            "منصة الأسئلة والأجوبة الموثوقة — "
            "اطرح سؤالاً أو ابحث عن إجابة من خبراء حقيقيين 🔍",
            site_url("social", 13),
            "🔍 ابحث في كورا"
        ),
        lambda: (
            "🔵 *في كي (VK)*\n\n"
            "شبكة اجتماعية روسية بمحتوى ضخم — "
            "مجتمعات ومجموعات ومقاطع فيديو لا تجدها في مكان آخر 🌐",
            site_url("social", 14),
            "🌐 استكشف في كي"
        ),
    ],
    ...
    "tech": [
        ...
        lambda: (
            ...
            "APK Play يوفر تطبيقات أندرويد مدفوعة بدون دفع — "
        ...
        lambda: (
            ...
            "Traidsoft يجمع لك برامج الكمبيوتر الاحترافية — "
            "فوتوشوب، مونتاج، برمجة وأكثر بدون دفع 🖥️",
            site_url("tech", 6),
            "🖥️ ابحث في برامج الكمبيوتر"
        ),
        lambda: (
            "📦 *تطبيقات لكل الأنظمة — Softmany*\n\n"
    ...
    "tv": [
        ...
        lambda: (
            "📡 *بث عربي بديل — مصدر ثانٍ*\n\n"
            "مجموعة ثانية من القنوات العربية المباشرة — "
            "إذا كان المصدر الأول مشغولاً، هذا البديل جاهز دائماً 📺",
            site_url("tv", 2),
            "📺 جرّب البث البديل"
        ),
        lambda: (
            "🌍 *قنوات عالمية — من كل دولة*\n\n"
            "Sportika يجمع قنوات من كل أنحاء العالم ببث مباشر — "
            "أخبار، ثقافة، رياضة عالمية من مصدرها الأصلي 🌐",
            site_url("tv", 3),
            "🌐 تصفّح القنوات العالمية"
        ),
        lambda: (
            "🗺️ *قنوات الدول — GlobeTV*\n\n"
