...
CATEGORY_MSGS = {
    ...
    "food": [
        ...
        lambda: (f"🥘 *طبخات كوم*\n\nآلاف الوصفات بالتفصيل — افتح طبخات كوم واختار وصفتك 🍽️", site_url("food", 5)),
    ...
    "anime": [
        ...
        lambda: (f"📖 *قراءة المانغا*\n\nاقرأ المانغا مباشرة — فصول جديدة في انتظارك. افتح وتابع 🎌", site_url("anime", 2)),
    ...
    "music": [
        ...
        lambda: (f"💿 *تحميل ألبومات كاملة*\n\nحمّل ألبومات كاملة — افتح وتصفح 🎼", site_url("music", 4)),
    ...
    "tv": [
        ...
        lambda: (f"📡 *قنوات عربية 2*\n\nبث مباشر للقنوات العربية — افتح وتصفح 📺", site_url("tv", 2)),
