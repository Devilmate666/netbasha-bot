...
CATEGORY_MSGS = {
    "movies": [
        "🎬 *الأفلام الجديدة وصلت!*\n\nالتشكيلة تتجدد باستمرار — أكشن، رومانسي، رعب، ودراما. شوف اللي يناسبك ومتفوتش حاجة 🍿\n\n👉 [افتح نت باشا دلوقتي](" + APP_URL + ")",
        "🎥 *عندك وقت فراغ؟*\n\nعندنا أحدث الأفلام بجودة عالية ومترجمة بدقة. ما تحتاجش تدور بعيد 😉\n\n👉 [شوف الأفلام على نت باشا](" + APP_URL + ")",
        "🏆 *أفلام الأسبوع الأكثر مشاهدة*\n\nهوليوود، بوليوود، وأفلام عربية — كلها في مكان واحد 🎞️\n\n👉 [نت باشا — ما تفوتكش](" + APP_URL + ")",
